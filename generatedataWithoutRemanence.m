function generatedataWithoutRemanence

model = zeros(10,20,20);

model(2:5,4:8,4:8) = 0.04;  % effective susceptibility
% model(2:5,4:8,12:16) = 0.04;
% model(2:5,12:16,4:8) = 0.04;
...
% indicator(2:5,4:8,12:16) = 2;
% indicator(2:5,12:16,4:8) = 3;
...
% Rem1_incl = 45;   % inclination for the first remenant magnetization is -40 degrees.
% Rem1_decl = 25;    % declination for the first remenant magnetization is 80 degrees.
% 
% Rem2_incl = 10;   % inclination for the second remenant magnetization is 10 degrees
% Rem2_decl = 40;   % declination for the second remenant magnetization is 40 degrees.
% 
% Rem3_incl = 50;
% Rem3_decl = 100;
...
fid = fopen('obs_noremanence.dat','w');
